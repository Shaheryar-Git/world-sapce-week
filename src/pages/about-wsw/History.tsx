...
const History = () => {
  ...
  const milestones = [
  { id: 1, year: 2024, theme: "Space & Climate Change Impact", poster: "🌍", report: "available" },
  { id: 2, year: 2023, theme: "Space and Entrepreneurship", poster: "🚀", report: "available" },
  { id: 3, year: 2022, theme: "SPACE AND SUSTAINABILITY", poster: "♻️", report: "available" },
  { id: 4, year: 2021, theme: "WOMEN IN SPACE", poster: "👩‍🚀", report: "available" },
  { id: 5, year: 2020, theme: "Satellites Improve Everyday Life", poster: "🛰️", report: "available" },
  { id: 6, year: 2019, theme: "The Moon: Gateway to the Stars", poster: "🌙", report: "available" },
  { id: 7, year: 2018, theme: "SPACE UNITED THE WORLD", poster: "🌐", report: "available" },
  { id: 8, year: 2017, theme: "EXPLORING NEW WORLDS IN SPACE", poster: "🪐", report: "available" },
  { id: 9, year: 2016, theme: "REMOTE SENSING, ENABLING OUR FUTURE", poster: "🖼️", report: "available" },
  { id: 10, year: 2015, theme: "DISCOVERY", poster: "🔭", report: "available" },
  { id: 11, year: 2014, theme: "SPACE GUIDING YOUR WAY", poster: "🧭", report: "available" },
  { id: 12, year: 2013, theme: "EXPLORING MARS, DISCOVERING EARTH", poster: "♂️", report: "available" },
  { id: 13, year: 2012, theme: "SPACE FOR HUMAN SAFETY AND SECURITY", poster: "🛡️", report: "available" },
  { id: 14, year: 2011, theme: "50 YEARS OF HUMAN SPACEFLIGHT", poster: "50", report: "available" },
  { id :15 ,year :2010 ,theme :"Mysteries of the Cosmos" ,poster :"🌌" ,report :"available"},

  { id: 16, year: 2008, theme: "EXPLORING THE UNIVERSE", poster: "🔭", report: "available" },
  { id: 17, year: 2007, theme: "50 YEARS IN SPACE", poster: "50", report: "available" },
  { id: 18, year: 2006, theme: "SPACE FOR SAVING LIVES", poster: "🩺", report: "available" },
  { id: 19, year: 2005, theme: "DISCOVERY AND IMAGINATION", poster: "💡", report: "available" },
  { id: 20, year: 2004, theme: "SPACE FOR SUSTAINABLE DEVELOPMENT", poster: "🌱", report: "available" },
  { id: 21, year: 2003, theme: "SPACE HORIZONS BEYOND", poster: "🚀", report: "available" },
  { id: 22, year: 2002, theme: "INSPIRATION FROM SPACE", poster: "✨", report: "available" },
  { id: 23, year: 2001, theme: "THE SPACE MILLENNIUM BEGINS", poster: "⏳", report: "available" },
  { id: 24, year: 2000, theme: "Space Millennium Begins", poster: "🌠", report: "available" },
  ];
			...
			<section className="relative py-32 bg-gradient-to-br from-[#220536] via-[#1a0429] to-[#0f0118] overflow-hidden">
				...
				>
					...
					<p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
						25 years of celebrating space exploration and education
						worldwide
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="relative">
						...
						{milestones.map((milestone, index) => (
							<Link
								to={`/about-wsw/Past-Theme-Reports-Posters/${milestone.id}`}
								className="block"
							>
								<div
									key={index}
								...
								>
									...
									>
										<div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
											<div className="text-2xl font-bold text-[#9326E0] mb-2">
												{milestone.year}
											</div>
											<h3 className="text-xl font-bold text-[#204d74] mb-4">
												{milestone.theme}
											</h3>
											<p className=" text-[#204d74]">
												{milestone.report}
											</p>
										</div>
									</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							Explore the themes and download reports from
							previous World Space Week celebrations
						</p>
					</div>
						...
						{themes.map((item, index) => (
							...
							>
								<div className="text-center mb-6">
									...
									<h3 className="text-lg font-bold text-[#204d74] mb-4">
										{item.theme}
									</h3>
								</div>
			...
			<section className="py-24 bg-gradient-to-b from-[#0f0118] to-[#1a0429] relative">
				...
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
					...
					<p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
						Access our complete archive of World Space Week
						materials, including historical documents, statistics,
						and multimedia content from past celebrations.
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
						<div className="bg-white/5 backdrop-blur-md border border-[#9326E0]/20 rounded-2xl p-6">
							...
							<p className="text-gray-300">
								Annual reports and statistics from each World
								Space Week
							</p>
						</div>
						...
						<div className="bg-white/5 backdrop-blur-md border border-[#204d74]/20 rounded-2xl p-6">
							...
							<p className="text-gray-300">
								Official posters from every year in high
								resolution formats
							</p>
						</div>
						...
						<div className="bg-white/5 backdrop-blur-md border border-[#9326E0]/20 rounded-2xl p-6">
							...
							<p className="text-gray-300">
								Educational materials and media kits from past
								years
							</p>
						</div>
					</div>
